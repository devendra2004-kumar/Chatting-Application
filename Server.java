...
public class Server  implements ActionListener {
    ...
    JTextField text;  //is used in server constructor and in a function also
    JPanel a1; 
    static Box vertical = Box.createVerticalBox();  //create vertical box for showing sender msg ek ke niche ek.-->static bna diya taki main method se call kiya ja sake

    //JFrame ko extend kiya tha pahle but ab object bna rahe hai taki main(static) method me call kiya ja sake
    ...
    Server(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("resource/1.png"));
        ...
        JLabel name = new JLabel("DEVENDRA");
    ...
    public static void main(String[] args) {
        ...
        try{                                        //Server being created as a server
